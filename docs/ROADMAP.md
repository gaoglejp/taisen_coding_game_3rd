...
| Practice solo mode | ✅ | PR #TBD — `/practice` reuses Blockly + `simulate()` against built-in bots via `POST /api/practice/simulate`; standalone, no Match/Socket.io/persistence. |
